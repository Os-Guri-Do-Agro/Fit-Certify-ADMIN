      ...
      <v-container class="position-relative w-100">
        <v-row align="center" class="min-height-300">
          <v-col cols="12" class="text-center">
            ...
            <p class="hero-subtitle">Gerencie suas conexões com atletas</p>
                  ...
                  <div v-else>
                    ...
                    <div v-if="minhasConexoes.length === 0" class="empty-state">
                      <v-card class="pa-12 text-center" rounded="xl" elevation="0" color="grey-lighten-5">
                        ...
                        <h3 class="text-h5 font-weight-bold mb-3">Nenhum atleta conectado</h3>
...
const buscarConexoesPagined = async () => {
  loading.value = true
  try {
    const response = await treinadorService.getConexoesPagined(page.value, pageSize.value)

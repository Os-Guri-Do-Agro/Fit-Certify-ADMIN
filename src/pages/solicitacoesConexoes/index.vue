                          ...
                          <v-col cols="12" sm="auto" class="text-center text-sm-left">
                            ...
                            >
                              <v-avatar size="90" class="avatar-shadow">
                                <v-img v-if="solicitacao.solicitante?.avatarUrl" :src="solicitacao.solicitante.usuario.avatarUrl" cover></v-img>
                      ...
                      <v-card-text class="pa-6">
                        <v-row align="center">
                          <v-col cols="12" sm="auto" class="text-center text-sm-left">
                            ...
                            >
                              <v-avatar size="90" class="avatar-shadow">
                                <v-img v-if="solicitacao.destinatario?.avatarUrl" :src="solicitacao.destinatario.usuario.avatarUrl" cover></v-img>
                                <v-icon v-else size="45" color="grey-darken-1">mdi-account</v-icon>
                              </v-avatar>
                            </v-badge>
                          </v-col>
                      ...
                      <v-card-text class="pa-6">
                        <v-row align="center">
                          <v-col cols="12" sm="auto" class="text-center text-sm-left">
                            ...
                            >
                              <v-avatar size="90" class="avatar-shadow">
                                <v-img v-if="isAtleta && getProfissional(conexao)?.avatarUrl" :src="getProfissional(conexao).usuario.avatarUrl" cover></v-img>
                                <v-img v-else-if="!isAtleta && conexao?.solicitante?.avatarUrl" :src="conexao.solicitante.usuario.avatarUrl" cover></v-img>
                                <v-icon v-else size="45" color="grey-darken-1">mdi-account</v-icon>
                              </v-avatar>
                            </v-badge>
                          </v-col>
